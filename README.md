...
<p align="center">
  Boulder, Colorado
  <br />
  <a href="mailto:vishnumahajan33@gmail.com">Email</a> |
  <a href="https://www.linkedin.com/in/vishnu-mahajan/">LinkedIn</a> |
  <a href="https://github.com/vishnu0222">GitHub</a>
</p>

## Overview

Software Engineer with experience building scalable applications, optimizing system performance, and developing reliable APIs
and cloud-based services. Skilled in TypeScript, Node.js frameworks, React, PostgreSQL, Docker, and AWS, with hands-on
experience delivering production-ready solutions across full stack and distributed systems environments.
...
August 2024 - May 2026 | Boulder, USA

### SRM Institute of Science and Technology
**Bachelor of Technology in Computer Science**  
July 2019 - July 2023 | Chennai, India
...
- Designed modular RESTful APIs for authentication, workout plans, and challenges using NestJS, Prisma ORM, DTO validation, and CI/CD checks.
- Implemented an event-driven architecture with RabbitMQ for asynchronous publish-subscribe and producer-consumer workflows.
- Integrated an AI fitness assistant using server-side OpenAI APIs with tool calling to fetch user plan and challenge data from PostgreSQL.
...
| Area | Result |
| --- | --- |
| API performance | Reduced a customer-facing endpoint from over 3 minutes to under 10 seconds by removing redundant DB queries and redesigning backend business logic |
| System reliability | Standardized API responses, fixed webhook misfires, added unit tests for critical flows, and improved release confidence |
| Data processing | Improved backend processing efficiency by 30% through optimized SQL operations and structured JSON workflows |
| Platform architecture | Built event-driven and AI-assisted systems using RabbitMQ, Redis, PostgreSQL, FastAPI, and OpenAI Agents SDK |

## Connect

If you are working on backend platforms, distributed systems, or AI-enabled products, I am always interested in thoughtful technical conversations and strong engineering teams.
